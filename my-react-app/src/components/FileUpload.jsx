  ...
  return (
    ...
    >
      ...
      <div className="grid gap-2">
        ...
        <div className="flex items-center justify-center">
          ...
          <label className="cursor-pointer">
            <input
              ...
              onChange={pickFile}
            />
            <div className="flex w-28 h-9 px-2 flex-col bg-indigo-600 rounded-full shadow text-white text-xs font-semibold leading-4 items-center justify-center focus:outline-none">
              {label}
            </div>
          </label>
        </div>
        ...
        {/* ファイル名 or エラー表示 */}
        {fileName && !error && (
          <p className="text-center text-xs text-gray-600">Selected: {fileName}</p>
        )}
